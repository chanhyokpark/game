...
nodes:
  ...
  scene1_2:
    text: '막 정문을 지나는데 벌써 조금 땀이 나는 것이 느껴집니다. 정문을 마주보고 있는 전봇대에 걸린 현수막이 눈에 들어옵니다. "구원받고 싶다면 믿으라." 현수막 상단에는 당신의 학교, 탐진 신학교의 로고가 박혀 있습니다. 지난번 현수막이 떨어진지 얼마나 됐다고, 벌써 무슨 일이 났나 봅니다. 누군가가 반역을 실패한 것 같네요, 아마.'
    image: '배경이미지1'
    next:
      id: scene1_3
  ...
  scene4_6:
    text: '"지금 당장 받아들이긴 어려울 거 알아. 생각할 시간은 충분히 줄게. 근데 이건 알아둬라. 난 이단이고, 너네한테도 반종교적인 걸 가르칠 거다. 싫으면 독립해라."'
    image: '상준1'
    next:
      id: scene4_7
